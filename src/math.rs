...
pub fn into_matrix4x4_with_pos<T: Number>(mat: Matrix3x3<T>, pos: Vec3<T>) -> Matrix4x4<T> {
    Matrix4x4::from_array(
        [
            [*mat.get_0_0(), *mat.get_0_1(), *mat.get_0_2(), pos.x],
            [*mat.get_1_0(), *mat.get_1_1(), *mat.get_1_2(), pos.y],
            [*mat.get_2_0(), *mat.get_2_1(), *mat.get_2_2(), pos.z],
            [T::ZERO, T::ZERO, T::ZERO, T::ONE],
        ]
    )
}
...
pub fn perspective_proj_matrix(fov: f32, near: f32, far: f32) -> Matrix4x4<f32> {
    ...
    Matrix4x4::<f32>::from_array([
        [s, 0_f32, 0_f32, 0_f32],
        [0_f32, s, 0_f32, 0_f32],
        [0_f32, 0_f32, (-far / (far - near)), (-far * near / (far - near))],
